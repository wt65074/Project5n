...
*/
public class HashMapSearch<K, V> implements Map<K, V> {
    ...
    private void rehash(int size) {
        ...
        for (Entry<K, V> e: temp) {
            if (e != null && !e.tombstone && this.place(e) != null) {
    ...
    private V removeKey(K k) {
        ...
        for (int i = 0; i < this.hashFunctions.length; i++) {
            ...
            if (found != null && found.key.equals(k)) {
                this.table[hash] = new Entry<K,V>(); // create tombstone
                this.count--;
                return found.value;
            }
    ...
    public static void main(String[] args) {
        ...
        HashMapSearch<Integer, Integer> map = new HashMapSearch<Integer, Integer>();
        Random r = new Random();
        ...
        for (int i = 0; i < 100 ; i++) {
            ...
            try {
                ...
                System.out.println("Could not insert " + n);
                map.printAll();
