...
*/
public class HashMapSub1SearchArray<K, V> implements Map<K, V> {
    ...
    private Entry<K, V> place(Entry<K, V> e) {
        ...
        while (displacements++ < this.maxDisplacements) {
            ...
            int position = hash(current, hashFunc);
